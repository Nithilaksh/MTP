...
This simulator takes lambda1 as the total expected demand of the system instead of individually. 
Lambda2 is considered as the expected individual bid
Created on Sat Sep 23 20:27:06 2017
...
ax.scatter(lambdaArray[:,0], lambdaArray[:,1], QoSArray[:,0], s = 2)
